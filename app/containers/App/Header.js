...
const useStyles = makeStyles(theme => ({
  ...
  searchIcon: {
    ...
    backgroundColor: '#fff',
    boxShadow:
      '0 2px 2px 0 hsla(0,0%,60%,.14), 0 3px 1px -2px hsla(0,0%,60%,.2), 0 1px 5px 0 hsla(0,0%,60%,.12)',
    transition:
      'box-shadow .2s cubic-bezier(.4,0,1,1),background-color .2s cubic-bezier(.4,0,.2,1)',
    '&:hover': {
      backgroundColor: '#fff',
      boxShadow:
        '0 14px 26px -12px hsla(0,0%,60%,.42), 0 4px 23px 0 rgba(0,0,0,.12), 0 8px 10px -5px hsla(0,0%,60%,.2)',
    },
  },
  icon: {
